...
```javascript
PATH_SEP = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep@v0.2.3-umd/browser.js"></script>
```
